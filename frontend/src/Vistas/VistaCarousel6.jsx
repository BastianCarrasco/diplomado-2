...
const VistaCarousel6 = ({ src, alt, isActive }) => {
  return (
    <div
      className={`carousel-item position-relative font-sans vh-100 ${
        isActive ? "active" : ""
      }`}
    >
      {/* Background Image */}
      ...
      >
        ...
        <div className="h-100 p-4 d-flex flex-column">
          ...
          >
            <div
              className="position-absolute w-100 h-100 bg-warning"
              style={{ opacity: 0.8, zIndex: 0 }}
            ></div>
            <h1
              className="position-relative text-white px-3 py-2"
              style={{
                zIndex: 1,
                fontSize: "2.5rem",
                fontWeight: "bold",
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 text-white">
                    ...
                    <p className="mb-0">
                      • Clases online sincrónicas (vía Zoom)
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 text-white">
                    ...
                    <p className="mb-0">
                      • Persona en posesión de título profesional, licenciatura
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 text-white">
                    ...
                    <p className="mb-0">
                      • 30% académicos/as y funcionarios/as PUCV
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 text-white">
                    ...
                    <p className="mb-0">
                      Para más información, contáctese con nuestros ejecutivos
                      al +569 72478601
                    </p>
                  </div>
                </div>
          ...
          <div className="position-absolute bottom-0 end-0 m-3">
            <div
              className="d-inline-block bg-warning p-3 rounded"
              style={{
                opacity: 0.9,
                width: "fit-content",
              }}
            >
              <p
                className="mb-1 font-montserrat font-bold"
              ...
              <br />
              <p
                className="mb-0 font-montserrat font-bold"
                style={{ color: "black", display: "inline" }}
              >
